...
public class HomeworkFilesActivity extends AppCompatActivity {
    ...
    public String homeworkFolderName = "Homework";

    //file paths
    public String rootPath;
    public File parentFolder;
    public File childFolder;
    public File homeworkFolder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_homework_files);
        ...
        homeworkFolder = new File(childFolder,homeworkFolderName);
        if (!homeworkFolder.exists()){
            homeworkFolder.mkdirs();
        }

        //initialise rv view
        recyclerView = findViewById(R.id.rvHW);
        recyclerView.setHasFixedSize(true);

        //initialise search view
        searchView = findViewById(R.id.searchViewHW);
    }
    ...
    protected void onStart() {
        ...
        if(homeworkFolder.exists()){
            ...
            File [] files = homeworkFolder.listFiles();
        ...
        pdfFileAdapter.setOnItemClickListener(new PdfFileAdapter.OnItemClickListener() {
            ...
            public void onShareClick(int position) {
                ...
                Uri pdfUri = FileProvider.getUriForFile(HomeworkFilesActivity.this, BuildConfig.APPLICATION_ID + ".provider", file);
    ...
    private void openPdfView(Uri uri, String fileName){
        ...
        Intent intent = new Intent(HomeworkFilesActivity.this, PdfViewerActivity.class);
    ...
    private boolean sharePdfFile(Uri pdfUri, String pdfName){
        ...
        Intent intent = new Intent(HomeworkFilesActivity.this, EmailExportActivity.class);
    ...
    private void showDeleteDialog(final Uri pdfFileUri){
        ...
        //dialog xml
        final View dialogView = inflater.inflate(R.layout.delete_homework_dialog, null);

        dialogBuilder.setView(dialogView);

        final ImageButton buttonNo = dialogView.findViewById(R.id.imageButtonNo3);
        final ImageButton buttonYes = dialogView.findViewById(R.id.imageButtonYes3);
    ...
    private void search(String str){
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(HomeworkFilesActivity.this));
        ...
        userDetails.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (currentUserAccount.equals(teacherAccountNav)) {
                    startActivity(new Intent(HomeworkFilesActivity.this, TeacherDashActivity.class));
                    finish();
                } else {
                    startActivity(new Intent(HomeworkFilesActivity.this, StudentDashActivity.class));
                    finish();
                }
            }
            @Override
